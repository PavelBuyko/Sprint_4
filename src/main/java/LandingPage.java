...
public class LandingPage {
    ...
    private final By BOTTOMBUTTONSCROLLPOINT = By.xpath("//div[@class='Home_FinishButton__1_cWm']");
    //номер вопроса
    ...
    {
        WebElement element = driver.findElement(By.xpath("//div[@id='accordion__panel-"+questionNumber+"']/parent::div")); //не может быть переведено в константу, потому что тело xpath имеет активную переменную.
    ...
    {
        WebElement element = driver.findElement(BOTTOMBUTTONSCROLLPOINT);
        ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView();", element);
        new WebDriverWait(driver, Duration.ofSeconds(3))
